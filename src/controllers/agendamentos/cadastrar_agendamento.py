...
# Controlador de cadastro de agendamentos
@jwt_required()
def cadastrar_agendamento():
    try:
        ...
        consulta = Agendamento.query.filter_by(
        ...
        if consulta:
            return (
                jsonify(
                    {
                        "mensagem": "Ja existe um agendamento feito nesse mesmo dia e horario"
                    }
                ),
                400,
            )
            ...
            jsonify(
                {
                    ...
                    "agendamento": schema.dump(agendamento),
                }
            ),
            201,
        )
